    ...
    if (filme.poster_path) {
      ...
      <div class="filme-container">
          ...
          <div class="filme-info">
              <h1>${filme.title}</h1>
              <p class="verMenos" id="${filme.id}">${filme.overview}</p>
              <button onclick="verMais(${filme.id})">Ver mais</button>
...
function verMais(id) {
  const descrisao = document.getElementById(id)
  descrisao.classList.toggle("verMenos")
}
